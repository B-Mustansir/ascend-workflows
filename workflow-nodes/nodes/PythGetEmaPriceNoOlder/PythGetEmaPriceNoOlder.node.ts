...
export class PythGetEmaPriceNoOlder implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Pyth Get EMA Price No Older',
		name: 'pythGetEmaPriceNoOlder',
		icon: 'file:pyth.svg',
		group: ['transform'],
		version: 1,
		description: 'Fetch EMA price for a Pyth price feed ID with age limit',
		defaults: { name: 'Pyth Get EMA Price No Older' },
		inputs: ['main'],
		outputs: ['main'],
		properties: [
			{
